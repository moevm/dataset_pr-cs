...
class Car(Transport):
    ...
    def __eq__(self, other_car):
        return self.average_speed == other_car.average_speed and self.max_speed == other_car.max_speed and self.power == other_car.power and self.wheels == other_car.wheels
...
class Plane(Transport):
    ...
    def __eq__(self, other_plan):
        return self.wingspan == other_plan.wingspan
...
class Ship(Transport):
    ...
    def __eq__(self, other_plan):
        return self.length == other_plan.length and self.side_height == other_plan.side_height
