class Character:
    def __init__(self, gender, age, height, weight):
        if not (gender in 'mw' and isinstance(age, int) and age > 0 and isinstance(age, int) and height > 0 and isinstance(age, int) and weight > 0):
...
class Warrior(Character):
    ...
    def __eq__(self, other):
        return isinstance(other, Warrior) and (self.physical_damage == other.physical_damage) and (self.forces == other.forces) and (self.armor == other.armor)
...
class Archer(Character):
    ...
    def __eq__(self, other):
        return isinstance(other, Archer) and (self.physical_damage == other.physical_damage) and (self.forces == other.forces) and (self.attack_range == other.attack_range)
