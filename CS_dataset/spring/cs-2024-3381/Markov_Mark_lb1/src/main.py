class Transport:
    ...
    def __init__(self, average_speed, max_speed, price, cargo, color):
        ...
        if (isinstance(average_speed, int) and average_speed > 0) and (
                isinstance(max_speed, int) and max_speed > 0) and (isinstance(price, int) and price > 0) and (
...
class Car(Transport):
    ...
    def __eq__(self, other):
        if isinstance(other, Car):
            return self.average_speed == other.average_speed and self.max_speed == other.max_speed \
