...
class Car(Transport):
    ...
    def __eq__(self, others):
        if isinstance(others, Car):
            return self.average_speed == others.average_speed and self.max_speed == others.max_speed and self.power == others.power and self.wheels == others.wheels
...
class Plane(Transport):
    ...
    def __eq__(self, others):
        if isinstance(others, Plane):
            return self.wingspan == others.wingspan
