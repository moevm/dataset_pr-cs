...
d = {
    ...
    'q3': {'a': 'a;L;q4', 'b': 'b;L;q3', 'c': 'c;L;q3'}, # поиск крайнего правого символа 'a' (переход к состоянию q4)
    'q4': {'a': 'a;L;q5', 'b': 'b;L;q3', 'c': 'c;L;q3'}, # проверка символа перед крайним правым символом 'a' (если 'a', то перейти к q5, если нет - q3)
