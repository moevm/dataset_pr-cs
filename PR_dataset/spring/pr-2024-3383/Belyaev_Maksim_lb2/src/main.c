...
MusicalComposition* createMusicalComposition(char* name, char* author,int year){
    MusicalComposition *MusicalCom = malloc(sizeof(MusicalComposition));
    MusicalCom->name=name;
    MusicalCom->author=author;
    MusicalCom->year=year;
    MusicalCom->next=NULL;
    MusicalCom->prev=NULL;
    return MusicalCom;
};
